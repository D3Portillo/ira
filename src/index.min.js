...
/**
   ...
   */
function ira(url="string",extra){return makeIraFetch(IRA_METHODS.get,{acceptsBody:false})(url,extra)}function makeIraFetch(method="POST",opt={acceptsBody:true}){
/**
     * Ira Response Object
...
config={...IRA_CONFIG}}ira._config={...IRA_CONFIG,...config}}
/**
